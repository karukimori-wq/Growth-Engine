...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const recordedSession = {
      ...
      workspaceId: asString(maybeSession.workspaceId) ?? sessionStartTestPayload.workspaceId,
      status: asString(maybeSession.status),
      sourceApp: asString(maybeSession.sourceApp) ?? sessionStartTestPayload.sourceApp,
      sessionType: asString(maybeSession.sessionType) ?? sessionStartTestPayload.sessionType
    };
    ...
    return NextResponse.json({
      ...
      error: errorCode ? {
        ...
        retryable: errorCode === "UPSTREAM_TIMEOUT" || errorCode === "UPSTREAM_UNAVAILABLE" || errorCode === "UPSTREAM_BAD_RESPONSE",
        sourceApp: sessionStartTestPayload.sourceApp,
        targetApp: "numeria-studio",
        traceId,
        correlationId
